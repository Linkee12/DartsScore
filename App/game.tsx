    ...
    return (
        <Stack spacing={5} display={"flex"} height={"100%"}>
            <Stack spacing={5} display={"flex"} flex={1} direction={matches ? "row" : "column"} color={"#E3DECE"}>
                <Stack display={"flex"} flex={1} bgcolor={"#11171D"} padding={3} borderRadius={5} maxHeight={"50vh"} position={"relative"}>
                    <Typography gutterBottom variant="h1" component="div" textAlign={"center"} fontSize={matches ? 100 : 80}>
                        {players[currentIndex].name}
                    </Typography>
                    <Typography variant="h1" component="div" fontWeight={700} fontSize={matches ? 150 : 100}>
